...
// Importing solid and outline icons
...
function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 bg-white flex items-center p-2 lg:px-5 shadow-md">
      {/* <h1>Header</h1> */}
      {/* left* ---fb logo and search bar*/}
      <div className="flex items-center">
        {/* nextjs image component 👇👇 --- inserting FB image */}
        <Image
          ...
          layout="fixed"
        />
        {/* icon from heroicons https://heroicons.com/ and input */}
